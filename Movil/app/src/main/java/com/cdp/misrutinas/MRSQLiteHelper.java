...
public class MRSQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        tables[1][0] = "CREATE TABLE Usuario (id_usuario INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, apellido VARCHAR(15) NOT NULL, nombre VARCHAR(15) NOT NULL, dni INTEGER NOT NULL, email VARCHAR(75) NOT NULL, tel VARCHAR(15) NOT NULL, pass VARCHAR(16) NOT NULL, id_rol INTEGER, FOREIGN KEY (id_rol) REFERENCES Rol(id_rol))";
        tables[1][1] = "Usuario";
